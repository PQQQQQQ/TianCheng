# -*- coding: utf-8 -*-
"""
Created on Fri Dec  7 19:07:15 2018

@author: PQ
"""

import pandas as pd
Test_trans = pd.read_csv('../data/transaction_round1_new.csv')
Test_tag = pd.read_csv('../Result/lgb_baseline_12-07-17-33.csv')  # 测试样本
...
pred_data_rule[['UID', 'Tag']].to_csv('../Result/pred_data_rule_1207.csv', index=False)